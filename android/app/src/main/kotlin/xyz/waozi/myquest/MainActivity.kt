...
class MainActivity : SDLActivity() {
    companion object {
        // JNI method to set the asset manager
        @JvmStatic
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            // Pass the asset manager to native code
    ...
    override fun onWindowFocusChanged(hasFocus: Boolean) {
        ...
        try {
            ...
            Log.d("MainActivity", "onWindowFocusChanged completed")
        } catch (e: Exception) {
            Log.e("MainActivity", "Error in onWindowFocusChanged", e)
        }
    }
    ...
    private fun hideSystemUI() {
        try {
            ...
            Log.d("MainActivity", "hideSystemUI completed")
        } catch (e: Exception) {
            Log.e("MainActivity", "Error in hideSystemUI", e)
        }
    }
}
